/*
 * $Id: usbip_common.h 97 2006-03-31 16:08:40Z taka-hir $
 *
...
#define udbg(fmt, args...)						\
	do{								\
		printk(KERN_INFO "%-10s:(%s,%d) %s: " fmt,		\
...
#if CLIENT > 2
#define USBIP_HEARTBEAT_ECHO	0x0010 // added by zl for heartbeat echo cmd 2011-1-21
#define USBIP_HEARTBEAT_REPLY   0x0011 // added by zl for heartbeat reply cmd 2011-1-24
#endif
...
void log_to_web(int priority, char *fmt);	/* added by tf, 110513, print log to webserver */
