...
/* ---------------------------------------------------------------------- */
/* Reserve a remote USB device. added by tf, 110604 */
#define OP_RESERVE	0x06
#define OP_REQ_RESERVE	(OP_REQUEST | OP_RESERVE)
#define OP_REP_RESERVE   (OP_REPLY   | OP_RESERVE)
