...
var ERR_QOS_PARAM											= 27000/* 错误参数*/
var ERR_QOS_NOBUF											= 27001/* 已经没有空间*/
var ERR_QOS_NOENT											= 27002/* 不存在在信息*/
var ERR_QOS_EXIST											= 27003/* 该信息已经存在*/
var ERR_QOS_USEDBW											= 27004/* 新的QoS 带宽小于已使用的带宽*/
var ERR_QOS_NOBW											= 27005/* 系统不能满足所要求的带宽*/
var ERR_QOS_BADRULE											= 27006/* 规则有交集*/
var ERR_QOS_TYPE											= 27007/* 错误的类型*/
var ERR_QOS_MAX												= 27008/*the max error code */
var ERR_QOS_INGRESS_BANDWIDTH								= 27009 /*下行带宽总算大于系统提供总数*/
var ERR_QOS_EGRESS_BANDWIDTH								= 27010    /*上行带宽总数大于系统提供总算*/
...
str_err[ERR_STATIC_DEST_CONFLICT_LAN_WAN]		=	"Destination IP address can not be in the same subnet with WAN or LAN IP address, please input another one.";
...
str_err[ERR_QOS_PARAM]   						=   "The parameters are Error!";
str_err[ERR_QOS_BADRULE]						=   "The rule you add conflicts with the existed rule, please and input again.";
...
str_err[ERR_FIREWALL_LAN_PORT_FORMAT_ERROR]		=	"LAN port is out of range (1~65534). Please input another number such as 8080.";
str_err[ERR_FIREWALL_WAN_IP_FORMAT_ERROR]		=	"Bad WAN IP address, please input another one such as 61.145.238.5.";
str_err[ERR_FIREWALL_WAN_PORT_FORMAT_ERROR]		=	"WAN port is out of range (1~65534). Please input another number such as 8080.";
...
str_err[ERR_FIREWALL_WZD_PORT_FORMAT_ERROR]		=	"Incorrect port number,<br>please input another port number (1-65534) or a range of port numbers or two commas ',' to separate several ports.<br>If you input port, make sure that the number is available such as 8080 or 2300-9600.<br>";
...
str_err[ERR_REMOTE_MANAGE_PORT_OUT_OF_RANGE]	=	"Port is out of range (1-65534), please input another one.";
...
str_err[ERR_VS_PORT_OUT_RANGE]					=	"Port is out of range (1-65534). Please input another one.";
...
str_err[ERR_WLAN_MAC_FILTER_RECORD_ALREADY_FULL]=	"Already reach the max number of wireless ACL entries: 64";
// add by lsz 071103
...
str_err[ERR_WLAN_OPER_MODE]											=		"The operation mode setting is incorrect."
...
str_err[ERR_WLAN_MODE_UNSUPPORT_CFG]            =   "Current operation mode can not support this config."
