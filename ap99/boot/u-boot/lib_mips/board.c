...
void board_init_r (gd_t *id, ulong dest_addr)
{
    ...
    /* turn off SYS_LED & QSS_LED & USB_LED at the same time when enet leds be turned off */
...
#define SETBITVAL(val, pos, bit)				\
	...
	SETBITVAL(gpio, CONFIG_GPIO_JUMPSTART_LED_BIT,!CONFIG_GPIO_JUMPSTART_LED_ON);
	SETBITVAL(gpio, CONFIG_GPIO_READY_STATUS_BIT, !CONFIG_GPIO_READY_STATUS_ON);
	SETBITVAL(gpio, CONFIG_GPIO_USB_LED_BIT, !CONFIG_GPIO_USB_LED_ON);
