...
LIBS_BOOTSTRAP += cpu/$(CPU)/ar7240/libar7240.a
endif
...
LZMA = $(BUILD_DIR)/build/util/lzma
SQUASHFSLZMADIR = $(BUILD_DIR)/build/squashfs-lzma
...
u-boot.lzimg: $(obj)u-boot.bin System.map sqlzma_build
...
ifdef FLASH_SIZE
	...
	@./mkconfig -a ap99 mips mips ap99 ar7240 ar7240
ap99tpl_config 		: 	unconfig
	@ >include/config.h
	@echo "#define CONFIG_AR7240 1" >>include/config.h
ifdef FLASH_SIZE
	@echo "#define FLASH_SIZE $(FLASH_SIZE)" >>include/config.h
endif
	@./mkconfig -a ap99tpl mips mips ap99 ar7240 ar7240
