 ...
 *
 *	Version: $Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/net/ipv4/devinet.c#1 $
 *
...
struct ipv4_devconf ipv4_devconf = {
	...
	.secure_redirects = 1,
	.shared_media =	  1,
	.arp_ignore = 1,	/* ignore if tip isnot configured on the incoming interface - by lsz 090304 */
};
