...
unsigned long ip_ct_tcp_timeout_syn_sent =     30 SECS;
unsigned long ip_ct_tcp_timeout_syn_recv =     30 SECS;
unsigned long ip_ct_tcp_timeout_established =  30 MINS;
unsigned long ip_ct_tcp_timeout_fin_wait =     30 SECS;
unsigned long ip_ct_tcp_timeout_close_wait =   30 SECS;
unsigned long ip_ct_tcp_timeout_last_ack =     30 SECS;
unsigned long ip_ct_tcp_timeout_time_wait =    30 SECS;
