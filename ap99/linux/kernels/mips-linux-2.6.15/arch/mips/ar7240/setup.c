...
void Uart16550Init()
{
    ...
    MY_WRITE(0xb8040000, 0xdff);
    ledval = (!CONFIG_GPIO_JUMPSTART_LED_ON <<  CONFIG_GPIO_JUMPSTART_LED_BIT) 
    		| (!CONFIG_GPIO_READY_STATUS_ON << CONFIG_GPIO_READY_STATUS_BIT)
		| (!CONFIG_GPIO_USB_LED_ON << CONFIG_GPIO_USB_LED_BIT);

    MY_WRITE(0xb8040008, ledval);
    /* Enable UART , SPI and Disable S26 UART */ 
    MY_WRITE(0xb8040028, (ar7240_reg_rd(0xb8040028) | 0x48003));
